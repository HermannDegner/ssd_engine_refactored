...
社会的力学の基礎 - **ミクロ（個人）とマクロ（社会）のシームレスな統合**

**主要クラス:**
- `Society` - 社会システム（多エージェント E/κダイナミクス）
- `RelationshipMatrix` - 関係性マトリクス（協力/中立/競争）
- `SocialCouplingParams` - 社会的カップリングパラメータ

**機能:**
- マルチエージェントシミュレーション
- エネルギー伝播（ζ係数）: 感情・恐怖・興奮の伝染
- κ伝播（ξ係数）: 規範・技術・価値観の学習
- 競争による増幅（ω係数）: 協力では共感、競争では対立
- 集団現象の創発（革命、パニック、規範形成、文化伝播）

**理論的背景:**
- **基盤理論**: SSD基本理論（構造主観力学：シンプル版）の直接的応用
  - E/κダイナミクスを個人から社会へ拡張
  - 同じ原理で個人心理も社会現象も記述
...
- **創発メカニズム**:
  ```
  個人のE/κ → 関係性マトリクス経由で伝播 → 集団現象の創発
  ```
  
- **ドキュメント:**
  - [構造主観力学：シンプル版](https://github.com/HermannDegner/Structural-Subjectivity-Dynamics/blob/main/構造主観力学：シンプル版.md)
  - [人間モジュール　コア](https://github.com/HermannDegner/Structural-Subjectivity-Dynamics/blob/main/Human_Module/人間モジュール　コア.md)
